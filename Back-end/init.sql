...
CREATE TABLE usuarios (
    ...
    perfil VARCHAR(20) NOT NULL -- ADMIN, OPERADOR
);
...
-- Inserindo um Admin inicial (Senha: admin123 - Exemplo de hash fixo para teste)
INSERT INTO usuarios (nome, matricula, login, senha, perfil) 
VALUES ('Administrador', 'ADM001', 'admin', '$2a$10$8.VAgduz.S6y3Z0G.j2I3u6iXFpD.PjRz.e9WpW0e0WpW0e0WpW0e', 'ADMIN');